      ...
      <section className="w-full py-12 sm:py-16 lg:py-20 pt-[209px] sm:pt-[155px] lg:pt-[95px] xl:pt-[150px]">
        <div className="mx-auto max-w-[1340px] px-4 sm:px-6 xl:px-0">
          <div className="text-center">
            <h1 className="text-[#2958A4] text-[48px] sm:text-[56px] lg:text-[66px] font-medium leading-[58px] sm:leading-[66px] lg:leading-[76px] tracking-[-1.92px] sm:tracking-[-2.24px] lg:tracking-[-2.64px]">
              Our Story
            </h1>
            <p className="mt-6 mx-auto text-[#2958A4] text-center font-satoshi text-[24px] font-medium leading-[26px]">
      ...
      <section className="w-full py-12 sm:py-8 lg:py-10">
        <div className="mx-auto max-w-[1340px] px-4 sm:px-6 xl:px-0">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            {/* Left: Text Content */}
            <div>
              <h2 className="text-[#2958A4] text-[40px] sm:text-[48px] lg:text-[56px] font-medium leading-tight tracking-[-0.04em]">
                What We Focus On
              </h2>
